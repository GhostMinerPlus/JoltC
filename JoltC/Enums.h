...
typedef enum JPC_SpringMode : uint8_t
{
	...
	JPC_SPRING_MODE_MASS_NORMALIZED_STIFFNESS_AND_DAMPING = 2,
} JPC_SpringMode;
...
ENSURE_ENUM_EQ(JPC_SPRING_MODE_MASS_NORMALIZED_STIFFNESS_AND_DAMPING, JPH::ESpringMode::MassNormalizedStiffnessAndDamping)
